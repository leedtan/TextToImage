...
def main():
	...
	parser.add_argument('--learning_rate', type=float,default=1e-5,#LEECHANGE default=0.0002,
					   help='Learning Rate')
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			if disc_break > 0:
				...
				if 1:#batch_no % 2 == 0:
					...
					img_mid = gen_mid[idx,:,:,:]
					r_mid = real_mid[idx,:,:,:]
					scipy.misc.imsave('output_images/' + str(i) + '_img_idx:' + str(batch_no) + 'full.jpg',img_full)
					scipy.misc.imsave('output_images/' + str(i) + '_img_idx:' + str(batch_no) + 'tiny.jpg',img_small)
					scipy.misc.imsave('output_images/' + str(i) + '_img_idx:' + str(batch_no) + 'mid.jpg',img_mid)
					scipy.misc.imsave('output_images/' + str(i) + '_img_idx:' + str(batch_no) + 'a_r_small.jpg',r_small)
					scipy.misc.imsave('output_images/' + str(i) + '_img_idx:' + str(batch_no) + 'a_r_mid.jpg',r_mid)
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_1_{}_temp.ckpt".format(args.data_set))
		if i%5 == 0:
