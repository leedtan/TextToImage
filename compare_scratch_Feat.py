...
import argparse
import model_fromscratch8 as model1
import model1Feat as model2
import random
import h5py
...
def main():
    ...
    parser.add_argument('--gf_dim', type=int, default=44,
                       help='Number of conv in the first layer gen.')
    
    parser.add_argument('--df_dim', type=int, default=54,
    ...
    for i in range(len(save_epoch)):
        for j in range((len(save_epoch))):
            modelFile1 = "./Data/ModelEval/scratch_checkpoint_epoch_%d.ckpt" % (save_epoch[i])
            modelFile2 = "./Data/ModelEval/Feat_checkpoint_epoch_%d.ckpt" % (save_epoch[j])
