...
class GAN:
    ...
    def build_model(self, beta1, beta2, lr):
        ...
        with tf.variable_scope('scope_1'):
            p_real_img, p_real_img_logit, p_real_txt, p_real_txt_logit,    = self.discriminator(t_real_image, t_real_caption)
            p_wrong_img, p_wrong_img_logit, p_wrong_txt, p_wrong_txt_logit   = self.discriminator(t_wrong_image, t_real_caption, reuse = True)
            
            
            p_fake1_img, p_fake1_img_logit, p_fake1_txt, p_fake1_txt_logit   = self.discriminator(fake_image1, t_real_caption, reuse = True)
            p_fake2_img, p_fake2_img_logit, p_fake2_txt, p_fake2_txt_logit   = self.discriminator(fake_image2, t_real_caption, reuse = True)
            p_fake3_img, p_fake3_img_logit, p_fake3_txt, p_fake3_txt_logit   = self.discriminator(fake_image3, t_real_caption, reuse = True)
            p_fake4_img, p_fake4_img_logit, p_fake4_txt, p_fake4_txt_logit   = self.discriminator(fake_image4, t_real_caption, reuse = True)
            p_fake5_img, p_fake5_img_logit, p_fake5_txt, p_fake5_txt_logit   = self.discriminator(fake_image5, t_real_caption, reuse = True)
        '''
        with tf.variable_scope('scope_1'):
            p_1_real_img_logit, p_1_real_txt_logit, p_1_real_img, p_1_real_txt    = self.discriminator1(t_real_image, t_real_caption)
            p_1_wrong_img_logit, p_1_wrong_txt_logit, p_1_wrong_img, p_1_wrong_txt   = self.discriminator1(t_wrong_image, t_real_caption, reuse = True)
            p_1_fake_img_logit, p_1_fake_txt_logit, p_1_fake_img, p_1_fake_txt   = self.discriminator1(fake_image1, t_real_caption, reuse = True)
        
        with tf.variable_scope('scope_2'):
            p_2_real_img_logit, p_2_real_txt_logit, p_2_real_img, p_2_real_txt   = self.discriminator2(t_real_image, t_real_caption)
            p_2_wrong_img_logit, p_2_wrong_txt_logit, p_2_wrong_img, p_2_wrong_txt   = self.discriminator2(t_wrong_image, t_real_caption, reuse = True)
            p_2_fake_img_logit, p_2_fake_txt_logit, p_2_fake_img, p_2_fake_txt   = self.discriminator2(fake_image2, t_real_caption, reuse = True)
            
        with tf.variable_scope('scope_3'):
            p_3_real_img_logit, p_3_real_txt_logit, p_3_real_img, p_3_real_txt   = self.discriminator3(t_real_image, t_real_caption)
            p_3_wrong_img_logit, p_3_wrong_txt_logit, p_3_wrong_img, p_3_wrong_txt   = self.discriminator3(t_wrong_image, t_real_caption, reuse = True)
            p_3_fake_img_logit, p_3_fake_txt_logit, p_3_fake_img, p_3_fake_txt   = self.discriminator3(fake_image3, t_real_caption, reuse = True)
            
        with tf.variable_scope('scope_4'):
            p_4_real_img_logit, p_4_real_txt_logit, p_4_real_img, p_4_real_txt   = self.discriminator4(t_real_image, t_real_caption)
            p_4_wrong_img_logit, p_4_wrong_txt_logit, p_4_wrong_img, p_4_wrong_txt   = self.discriminator4(t_wrong_image, t_real_caption, reuse = True)
            p_4_fake_img_logit, p_4_fake_txt_logit, p_4_fake_img, p_4_fake_txt   = self.discriminator4(fake_image4, t_real_caption, reuse = True)
            
        with tf.variable_scope('scope_5'):
            p_5_real_img_logit, p_5_real_txt_logit, p_5_real_img, p_5_real_txt   = self.discriminator5(t_real_image, t_real_caption)
            p_5_wrong_img_logit, p_5_wrong_txt_logit, p_5_wrong_img, p_5_wrong_txt   = self.discriminator5(t_wrong_image, t_real_caption, reuse = True)
            p_5_fake_img_logit, p_5_fake_txt_logit, p_5_fake_img, p_5_fake_txt   = self.discriminator5(fake_image5, t_real_caption, reuse = True)
