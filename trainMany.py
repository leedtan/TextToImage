	...
	for i in range(args.epochs):
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_stacked7_{}_temp.ckpt".format(args.data_set))
		if 0:#i%5 == 0:
			save_path = saver.save(sess, "Data/Models/stacked7_after_{}_epoch_{}.ckpt".format(args.data_set, i))
