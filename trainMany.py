...
def main():
	...
	parser.add_argument('--batch_size', type=int, default=6,#LEECHANGE default=64,
					   help='Batch Size')
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			sess.run([g1_optim, g2_optim, g3_optim, g4_optim, g5_optim],
				feed_dict = {
					...
					input_tensors['LambdaDAE']: 1e-3
				})
			sess.run([g1_optim, g2_optim, g3_optim, g4_optim, g5_optim],
				feed_dict = {
					input_tensors['t_real_caption'] : np.random.rand(args.batch_size, args.caption_vector_length)*.01,
					input_tensors['t_z'] : z_noise,
					input_tensors['l2reg']: 0,
					input_tensors['LambdaDAE']: 1e-3
				})
