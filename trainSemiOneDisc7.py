...
def main():
	...
	gan = modelSemi.GAN(model_options)
	...
	for i in range(args.epochs):
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_Semi7_{}_temp.ckpt".format(args.data_set))
		if i in args.save_epoch:
			save_path = saver.save(sess, "Data/ModelEval/Semi7_after_{}_epoch_{}.ckpt".format(i, args.data_set))
