...
def main():
	...
	gan = modelReallyStacked.GAN(model_options)
	...
	for i in range(args.epochs):
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			_, _, _, d_loss, g_loss, img1, img2,   = sess.run(
				[g1_optim, g2_optim, d_optim, loss['d_loss'], loss['g_loss'],outputs['img1'],outputs['img2'] ],
				feed_dict = {
					input_tensors['t_real_image'] : real_images,
			...
			if batch_no % 10 == 0:
				...
				#real_caption = caption_text[idx]
				scipy.misc.imsave('images_Stacked6/' + str(i) + '_img_idx:' + str(batch_no) + 'stage1.jpg',one_image)
				scipy.misc.imsave('images_Stacked6/' + str(i) + '_img_idx:' + str(batch_no) + 'stage2.jpg',two_image)
				scipy.misc.imsave('images_Stacked6/' + str(i) + '_img_idx:' + str(batch_no) + 'real.jpg',real_full)
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_stacked6_{}_temp.ckpt".format(args.data_set))
		if i%5 == 0:
			save_path = saver.save(sess, "Data/Models/stacked4_after_{}_epoch_{}.ckpt".format(args.data_set, i))
