...
def main():
	...
	parser.add_argument('--batch_size', type=int, default=80,#LEECHANGE default=64,
					   help='Batch Size')
	...
	gan = modelWgan.GAN(model_options)
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			if disc_break > 0:
				...
				if 1:#batch_no % 10 == 0:
					...
					img_mid = gen_mid[idx,:,:,:]
					r_mid = real_mid[idx,:,:,:]
					scipy.misc.imsave('images_wgan/' + str(i) + '_img_idx:' + str(batch_no) + 'full.jpg',img_full)
					scipy.misc.imsave('images_wgan/' + str(i) + '_img_idx:' + str(batch_no) + 'tiny.jpg',img_small)
					scipy.misc.imsave('images_wgan/' + str(i) + '_img_idx:' + str(batch_no) + 'mid.jpg',img_mid)
					scipy.misc.imsave('images_wgan/' + str(i) + '_img_idx:' + str(batch_no) + 'a_r_small.jpg',r_small)
					scipy.misc.imsave('images_wgan/' + str(i) + '_img_idx:' + str(batch_no) + 'a_r_mid.jpg',r_mid)
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_wgan_{}_temp.ckpt".format(args.data_set))
		if i%5 == 0:
			save_path = saver.save(sess, "Data/Models/wgan_after_{}_epoch_{}.ckpt".format(args.data_set, i))
