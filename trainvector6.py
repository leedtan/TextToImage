...
def main():
    ...
    parser.add_argument('--save_epoch', type=list, default=[2,5,7,10,14],
    ...
    num_disc_steps = 0
    time_size = 9072#df dim 30 : 19440
    ...
    for i in range(args.epochs):
        ...
        while batch_no*flower_dataset_batch_size < loaded_data['data_length']:
            ...
            if (batch_no == 1 and i in args.save_epoch):
                save_path = saver.save(sess, "Data/ModelEval/vector6_checkpoint_epoch_{}.ckpt".format(i))
