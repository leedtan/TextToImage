...
def main():
	...
	gan = modelOneGAN.GAN(model_options)
	...
	for i in range(args.epochs):
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			if batch_no % 10 == 0:
				...
				scipy.misc.imsave('images_OneGAN8/' + str(i) + '_img_idx:' + str(batch_no) + 'full.jpg',img_full)
				scipy.misc.imsave('images_OneGAN8/' + str(i) + '_img_idx:' + str(batch_no) + 'real.jpg',real_full)
			...
			if (batch_no % args.save_every) == 0:
				...
				save_path = saver.save(sess, "Data/Models/latest_model_onegan8_{}_temp.ckpt".format(args.data_set))
		if i%5 == 0:
			save_path = saver.save(sess, "Data/Models/mini7_after_{}_epoch_{}.ckpt".format(args.data_set, i))
